...
interface BluetoothController {
    ...
    fun requestDiscoverable(durationSeconds: Int = 300)
    ...
    suspend fun trySendMessage(
        ...
        onFileInfoResolved: (com.blackandblue.justshare.domain.chat.FileInfo) -> Unit = {},
        onBytesSent: (Long) -> Unit = {},
        onFileSent: (com.blackandblue.justshare.domain.chat.FileInfo) -> Unit = {}
    ): BluetoothMessage?
