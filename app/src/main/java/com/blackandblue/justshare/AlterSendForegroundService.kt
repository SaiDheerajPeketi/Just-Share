...
class AlterSendForegroundService : Service() {
    companion object {
        const val ACTION_START = "com.blackandblue.justshare.altersend.START_FOREGROUND"
        const val ACTION_STOP = "com.blackandblue.justshare.altersend.STOP_FOREGROUND"
